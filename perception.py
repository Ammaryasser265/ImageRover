...
def find_rock(img):
    ...
    #define BGR threshold for dark and bright yellow
    lower_yellow = np.array([95,95,0])
    upper_yellow = np.array([255, 255, 21])
...
def perception_step(Rover):
    ...
    Rover.vision_image[:,:,1] = find_rock(Rover.img)*255
    Rover.vision_image[:,:,2] = find_obstacle(Rover.img) *255
